...
plt.title("Rewards collected over the time for Roulette game with tabular Q-learning")
...
plt.savefig('roulette_q_learning_v2.png');
os.remove("/home/giacomo/Scrivania/Q_Learning_Games_v2_/Q_Learning_Games_v2/Roulette_Q_Learning_Game/Roulette_Analysis/rewards_roulette_qlearning.txt")#to remove the file
