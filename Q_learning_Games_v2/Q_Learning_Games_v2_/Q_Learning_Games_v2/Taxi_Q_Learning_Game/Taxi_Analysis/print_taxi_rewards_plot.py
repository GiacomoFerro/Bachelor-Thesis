...
plt.title("Rewards collected over the time for Taxi game with tabular Q-learning")
...
plt.savefig('taxi_q_learning_v2.png');
os.remove("/home/giacomo/Scrivania/Q_Learning_Games_v2_/Q_Learning_Games_v2/Taxi_Q_Learning_Game/Taxi_Analysis/rewards_taxi_qlearning.txt")#to remove the file
