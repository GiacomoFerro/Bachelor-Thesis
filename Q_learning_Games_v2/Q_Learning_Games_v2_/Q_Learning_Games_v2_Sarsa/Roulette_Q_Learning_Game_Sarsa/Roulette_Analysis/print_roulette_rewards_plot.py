...
plt.title("Rewards collected over the time for Roulette game with Sarsa Algorithm")
...
plt.savefig('roulette_sarsa.png');
os.remove("/home/giacomo/Scrivania/Q_Learning_Games_v2_/Q_Learning_Games_v2_Sarsa/Roulette_Q_Learning_Game_Sarsa/Roulette_Analysis/rewards_roulette_sarsa.txt")#to remove the file
